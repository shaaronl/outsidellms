...
const nextConfig: NextConfig = { output: process.env.JAMQUEST_STATIC_BUILD === "1" ? "export" : undefined, allowedDevOrigins: ["127.0.0.1"], images: { unoptimized: true, remotePatterns: [] } };
